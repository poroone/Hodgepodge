...
![渲染流程图](D:\学习\poroone\utils\Nodejs\image\渲染流程图.png)
...
![webkit](D:\学习\poroone\utils\Nodejs\image\webkit.png)
...
![webkit](D:\学习\poroone\utils\Nodejs\image\V8编译过程.png)
...
1. Parse模块会将JavaScript代码转换成AST（抽象语法树），这是因为解释器并不直接认识JavaScript代码；
   ...
   2. Parse的V8官方文档：https://v8.dev/blog/scanner![V8Parser](D:\学习\poroone\utils\Nodejs\image\V8Parser.png)
...
2. Ignition是一个解释器，会将AST转换成ByteCode（字节码）
	...
	3. Ignition的V8官方文档：https://v8.dev/blog/ignition-interpreter![v8lgnitionpng](D:\学习\poroone\utils\Nodejs\image\v8lgnitionpng.png)
...
3. TurboFan是一个编译器，可以将字节码编译为CPU可以直接执行的机器码；
	...
	3. TurboFan的V8官方文档：https://v8.dev/blog/turbofan-jit![V8TurboFan](D:\学习\poroone\utils\Nodejs\image\V8TurboFan.png)
...
![浏览器和nodejs的区别](D:\学习\poroone\utils\Nodejs\image\浏览器和nodejs的区别.png)
...
2. libuv提供了事件循环、文件系统读写、网络IO、线程池等等内容；
   ...
   ![Nodejs架构图](D:\学习\poroone\utils\Nodejs\image\Nodejs架构图.png)
